...
public class ForecastObject  {
    ...
    public ForecastObject(int windDirection, double windSpeed, double minTemp, double maxTemp, double curTemp, double humidity, double pressure, double nightTemp, double dayTimeTemp, double eveningTemp, double morningTemp, Boolean heatIndex, String cityName, String day, String curForecast, String dayTimeForecast, String eveningForecast, String morningForecast, String nightForecast, String icon, String countryName, GeoPoint latLon, Timestamp date) {
    ...
    public ForecastObject(ForecastObject forecastObj) {
